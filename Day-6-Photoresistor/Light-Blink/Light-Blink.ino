...
void loop() {
   ...
   */
  Serial.print("Brightness/Delay: ");  // Display label string to serial monitor
  ...
  Serial.print("/");  // display label after light_value
  Serial.print(delay_value);      // display delay_value returned by map() function with newline

  Serial.print(" | Darkest/Brightest: ");
  Serial.print(darkest_light);
  Serial.print("/");
  Serial.print(brightest_light);

  unsigned int nits = light_value * 20;
  Serial.print(" | Nits: ");
  Serial.println(nits);
